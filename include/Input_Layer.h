...
public:
    ...
    Input_layer(Input_layer &&input_layer) = default;
    Input_layer& operator=(Input_layer &&input_layer) = default;
    ...
    Tensor *  Backpropogate(Tensor* gradient) override { return _gradient.get(); }
