...
#nn.add_fully_connected_layer(25, Activation_Function.Relu)
nn.add_output_layer(1, Activation_Function.Relu)

nn.build()
#nn.setLearningRate(0.01)
#nn.train([[0.2], [0.4]], [[0.4],[0.8]],2,20000)
#nn.train([[0.2],[0.3],[0.4]], [[0.4],[0.6],[0.8]],3,10000)
#nn.train([[-10.0],[0.0],[8.0],[15.0],[22.0],[38.0], [50.0]], [[14.0],[32.0],[46.0],[59.0],[72.0],[100.0], [122.0]], 1,50000)
