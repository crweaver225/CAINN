...
nn.add_fully_connected_layer(400, Activation_Function.Sigmoid)
nn.add_fully_connected_layer(1200, Activation_Function.Relu)
nn.add_fully_connected_layer(2000, Activation_Function.Relu)
nn.add_fully_connected_layer(2000, Activation_Function.Relu)
...
nn.train([[-10.0],[0.0],[8.0],[15.0],[22.0],[38.0],[50.0],[12.0],[19.0],[44.0]], [[14.0],[32.0],[46.0],[59.0],[72.0],[100.0],[122.0],[53.6],[66.2],[111.2]], 10,5000, Loss.MSE)
