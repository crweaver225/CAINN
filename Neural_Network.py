...
class Neural_Network(object):
    def __init__(self):
        ...
        #lib.Neural_Network_test.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(ctypes.c_float))]
        #lib.Neural_Network_test.restype = ctypes.c_void_p
        ...
        #void Neural_Network::train(float **input, float **targets, int batch_size, int epochs) {
